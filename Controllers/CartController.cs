...
namespace ecomerce1.Controllers
{
    public class CartController : Controller
    {
        ...
        public IActionResult Confirm() 
        {
            ...
            //Console.WriteLine("        deliveryAddress:" + deliveryAddress + "       paymentMethod:" + paymentMethod);

            TempData.Keep();

           // Console.WriteLine("cartSize:" + cartSize + "        deliveryAddress:" + deliveryAddress + "       paymentMethod:" + paymentMethod); 
